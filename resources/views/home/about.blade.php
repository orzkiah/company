...
<head>
  ...
  <div class="title-container text-center ">
    ...
    <div class="row mt-4">
      <div class="col-md-5" data-aos="fade-right">
        <center><h2 class="fw-bold about-us-title">
          {{$about->judul}}
        </h2></center>
  ...
  <<div class="teams bg-light mt-5 py-5">
    <div class="container">
        ...
        <p class="text-center">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quidem modi vero voluptas ea
            molestias eum illo, ducimus eius quisquam repellendus accusamus rerum! Repeliendus enim incidunt assumenda
            pariatur, quisquam evaniet numquam.
        </p>
        <div class="row">
            @foreach ($teams as $team)
            <div class="col-md-3 d-flex justify-content-center mb-4" data-aos="fade-up">
                <div>
                <center> <img src="image/{{$team->image}}" class="card-img-top rounded-circle" alt="..." style="object-fit: cover; width: 150px; height: 150px; margin: 0 auto;">
                  <div class="card-body">
                        <center><h5 class="card-title text-bold">{{$team->title}}</h5></center>
